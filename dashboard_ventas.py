...
# Nota: StockAdvancedService/OdooClient/Config se usan en pages/01_📦_Stock_LIVE.py
...
st.sidebar.info("📦 **Stock LIVE** ahora es una página dedicada en el sidebar superior →")
...
# Stock LIVE ahora vive en pages/01_📦_Stock_LIVE.py (página separada)
