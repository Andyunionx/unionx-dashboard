...
@st.cache_data(ttl=300, show_spinner="Consultando ventas Cyber en vivo…", max_entries=2)
...
@st.cache_data(ttl=600, show_spinner="Calculando promedio 4 semanas…", max_entries=2)
