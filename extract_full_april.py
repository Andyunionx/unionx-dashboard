#!/usr/bin/env python3
"""Extrae TODOS los datos de Abril (1-18) sin restricción de estado"""
...
print("[2] Extrayendo Abril 1-18 (SIN restricción)...")
...
print(f"[3] Preparando datos ({len(df):,} filas)...")
...
try:
    ...
    """, (
        ...
        'Odoo (Abril completo sin restriccion)',
        len(df),
        df['fecha_venta'].min(),
        df['fecha_venta'].max(),
        'full_month'
